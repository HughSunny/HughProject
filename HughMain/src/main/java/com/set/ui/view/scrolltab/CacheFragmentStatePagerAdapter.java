...
public abstract class CacheFragmentStatePagerAdapter extends FragmentStatePagerAdapter {
	 ...
	 * <p>
	 * Each fragments are automatically cached in this method, so you don't have
	 * to do it by yourself. If you want to implement instantiation of
	 * Fragments, you should override {@link #createItem(int)} instead.
	 * </p>
	 * <p/>
	 * {@inheritDoc}
	 *
	...
	/**
	 * Create a new Fragment instance. This is called inside
	 * {@link #getItem(int)}.
	 *
	 * @param position
	 *            Position of the item in the adapter.
