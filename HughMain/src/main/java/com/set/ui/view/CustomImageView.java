...
public final class CustomImageView extends SurfaceView implements SurfaceHolder.Callback {
	private static final String TAG = "ImageView";
	private int random;
	private int image_x;
	private int image_y;
	public static int image_w = 1024;
	public static int image_h = 720;
...
//			android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_URGENT_AUDIO);
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		mCanvas = mHolder.lockCanvas();
		mCanvas.drawBitmap(bitmapCurrent,null,new RectF(0, 0, getWidth(), getHeight()),paint);
		mHolder.unlockCanvasAndPost(mCanvas);
	}
...
//				}
	...
	private void prepareImage() {
		...
		bitmapCurrent = PublicTool.getBitmap(mSourceFile, image_w, image_h, 1);
		if (bitmapCurrent == null) {
