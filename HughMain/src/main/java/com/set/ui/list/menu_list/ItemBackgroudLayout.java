 ...
 */
class ItemBackgroudLayout extends ViewGroup {
    /* 下一个View的距离 */
    ...
    public ItemBackgroudLayout(Context context) {
        this(context, null);
    }

    public ItemBackgroudLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemBackgroudLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mBtnViews = new ArrayList<>();
        setVisibility(GONE);
    }

    protected View addMenuItem(ListMenuItem menuItem) {
        ...
        parent.setPadding(0,menuItem.margin,0,menuItem.margin);
    ...
    private ImageView createBG(ListMenuItem menuItem) {
    ...
    private TextView createTextView(ListMenuItem menuItem) {
    ...
    private ImageView createImageView(ListMenuItem menuItem) {
        ImageView imageView = new ImageView(getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < total; i++) {
            ...
            ListMenuItem menuItem = (ListMenuItem) view.getTag();
