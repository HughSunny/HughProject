    ...
    protected void setDragPosition(int position, boolean isWannaTransparentWhileDragging) {
        ...
        if (mOnDragListener != null && view instanceof ItemMainLayout) {
            ...
            if (isWannaTransparentWhileDragging) {
                UIUtil.setBackgroundDrawable(itemMainLayout.getItemCustomView(), new ColorDrawable(Color.TRANSPARENT));
            }
            ...
            if (isWannaTransparentWhileDragging) {
                UIUtil.setBackgroundDrawable(itemMainLayout.getItemCustomView(), backgroundDrawable);
            }
        }
    }
